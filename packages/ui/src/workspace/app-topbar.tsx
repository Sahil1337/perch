...
/**
 * The 48px bar across the top. Pure layout: it takes two slots and owns none of their state, so a
 * surface can put whatever it needs in them without this file growing a prop per feature.
 */
