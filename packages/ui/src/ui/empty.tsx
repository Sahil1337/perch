// Vendored primitive. Changed from upstream only by the import paths and an `outlined` variant on
// `Empty`, so it stays diffable against the source.
  ...
  return (
    <div
      className={cn(
        ...
        variant === "outlined" &&
          "gap-4 rounded-md border border-border border-dashed py-8 md:py-8",
        className,
      )}
      data-slot="empty"
